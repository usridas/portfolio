...
export const AlaskaAirlinesResearch1 = () => {
    ...
    const researchPlan1 = <TextContainer title={'OBJECTIVES'} text={'• What part of the booking flow is most confusing or difficult to complete?\n• What discourages or limits customers from completing a booking or attaching add-ons?\n• What does the ideal booking flow look like?'} />;
    ...
    const gridArray = [
        ...
        {title: 'THE PROBLEM', content: researchPlan},
...
export default AlaskaAirlinesResearch1;
