        ...
        <div className='steps'>
            ...
            <div className='step'>
                ...
                <div className='journeyCard'>
                    ...
                    <p>I conducted 6 usability tests, 2 moderated and 4 unmoderated tests.<br/><br/>Users face friction throughout the booking flow due to <span style={{fontWeight: 'bold', color: '#2519D2'}}>poor navigation and unclear flight information</span>, often causing them to miss or overlook important details. Users are also <span style={{fontWeight: 'bold', color: '#2519D2'}}>reluctant to purchase add-ons</span> unless they feel confident they're getting a good deal.</p>
                </div>
            </div>
            <div className='step'>
