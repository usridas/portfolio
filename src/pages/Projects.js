...
export const Projects = ({setTab}) => {
  ...
  const imageSlideProps = [
    {imagePath: KohiToKochaCover, title: "KŌHĪ TO KŌCHA DESIGN PROJECT", description: "January 2026", imageText: "SEE FULL DESIGN PROJECT", imageLink: "KohiToKocha", caption: "This was my final design project for UXDE 5100 Visual Design Fundamentals within my Master's program at the Columbus College of Art & Design. During this project, I used design principles to create a website for a fictional Asian bakery called Roll With It. I used sketching and Figma to gather inspiration, make a mood board, create web components, make low fidelity wireframes, and finally a high fidelity prototype."},
    ...
    {imagePath: TraderJoesCover, title: "TRADER JOE\'S RESEARCH PROJECT", description: "December 2025", imageText: "SEE FULL RESEARCH PROJECT", imageLink: "TraderJoesResearch", caption: "This was my final research project for GRID 5802 Design Research: Discovery within my Master's program at the Columbus College of Art & Design. During this research, I learned to how to conduct qualitative research through a research plan, interviewing, shadowing, affinity diagramming, journey mapping, and persona development."},
