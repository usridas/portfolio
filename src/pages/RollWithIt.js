...
export const RollWithIt = ({}) => {
    ...
    return (
        <div className="sectionContainer">
            ...
            {isLarge ? <LargeContent title={'SKETCHES'} content={sketches}/> : <SmallContent title={'SKETCHES'} content={sketches}/>}
            <hr className='divider'/>
            ...
            <hr className='divider'/>
            {isLarge ? <LargeContent title={'SKETCHED WIREFRAMES'} content={wireframes1}/> : <SmallContent title={'SKETCHED WIREFRAMES'} content={wireframes1}/>}
            <hr className='divider'/>
            {isLarge ? <LargeContent title={'DIGITIZED WIREFRAMES'} content={wireframes2}/> : <SmallContent title={'DIGITIZED WIREFRAMES'} content={wireframes2}/>}
            <hr className='divider'/>
            {isLarge ? <LargeContent title={'COMPONENTS'} content={components}/> : <SmallContent title={'COMPONENTS'} content={components}/>}
            <hr className='divider'/>
