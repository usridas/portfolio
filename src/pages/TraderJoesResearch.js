...
export const TraderJoesResearch = ({}) => {
    ...
    const researchPlan5 = <ImageSlide imageSlideProps={[{title: "PARTICIPANTS", imagePath: TraderJoesParticipants}]}/>;
    ...
    const affinityDiagram2 = <ImageSlide imageSlideProps={[{imagePath: TraderJoesAffinityDiagram}]}/>;
    ...
    const persona3 = <ImageSlide imageSlideProps={[{title: 'PERSONALITY TRAITS', imagePath: TraderJoesMayaPersonality}]}/>;
    const persona4 = <ImageSlide imageSlideProps={[{title: 'JOURNEY MAP', imagePath: TraderJoesMayaJourneyMap}]}/>;
    ...
    const persona7 = <ImageSlide imageSlideProps={[{title: 'PERSONALITY TRAITS', imagePath: TraderJoesJessPersonality}]}/>;
    const persona8 = <ImageSlide imageSlideProps={[{title: 'JOURNEY MAP', imagePath: TraderJoesJessJourneyMap}]}/>;
