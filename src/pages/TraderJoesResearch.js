    ...
    const summaryContent = <div className='columnWith24Gap'>
        ...
        <div className='steps'>
            ...
            <div className='step'>
                ...
                <div className='journeyCard'>
                    <h2 style={{textAlign: 'left'}}><span style={{display: isMobile ? 'unset' : 'none'}}>2. </span>Insights & Personas</h2>
