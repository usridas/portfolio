...
export const sriLankaTeaProjectInformation = {
    ...
    body: [
        {subtitle: 'Objective', bodyText: 'Creating a website that allows consumers to buy ethical tea from Sri Lanka. Also allows consumers to volunteer or donate in order to support tea plantation workers in Sri Lanka.  This project should encourage fair treatment of tea plantation workers.'},
...
export const seniorDesignInformation = {
    title: 'Senior Design: COVID-19 Project',
    body: [
        ...
        {subtitle: 'Android app', bodyText: 'These are the pages of my Android application. I wanted to include pastel colors, so as to not induce panic. The blues are associated with the medical field/medical terms, while the yellow serves as a caution, and red shows an alert.  I made these with Android Studio.'}
    ]
};
